...
'BackgroundColor',[1 1 1], ...
'Position',[10 195 fig_size(3)-20 180], ...
'Style','listbox', ...
'Tag','List of Views', ...
'FontSize',9,...
'FontName','Monaco',...
...
uicontrol('Parent',ptr, ...
'Units','pixels', ...
'BackgroundColor',[1 0.5 0], ...
'Position',[10 376 fig_size(3)-20 16], ...
'String','Views', ...
'Style','text', ...
'FontSize',14, ...
...
'Units','pixels', ...
'BackgroundColor',[1 1 1], ...
'Position',[10 5 fig_size(3)-20 12], ...
...
'Position',[bb+bw+bs bstart bw bh], ...
'String','Save', ...
'Tag','Pushbutton1');
uicontrol('Parent',ptr, ...
'Units','pixels', ...
...
'BackgroundColor',[0.9 0.9 0.5], ...
'Position',[bb+(bw+bs)*2 bstart bw bh], ...
'String','Add/Sub', ...
'Tag','Pushbutton1');
...
'BackgroundColor',[0.9 0.9 0.5], ...
'Position',[bb+bw+bs bstart-bv bw bh], ...
'String','Zoom in', ...
'Tag','Pushbutton1');
uicontrol('Parent',ptr, ...
'Units','pixels', ...
...
'BackgroundColor',[0.9 0.9 0.5], ...
'Position',[bb+(bw+bs)*2 bstart-bv bw bh], ...
'String','Zoom out', ...
'Tag','Pushbutton1');
...
'BackgroundColor',[0.9 0.9 0.5], ...
'Position',[bb+bw+bs bstart-bv*2 bw bh], ...
'String','Phase Plot', ...
'Tag','Pushbutton1');
uicontrol('Parent',ptr, ...
'Units','pixels', ...
...
'BackgroundColor',[0.9 0.9 0.5], ...
'Position',[bb+(bw+bs)*2 bstart-bv*2 bw bh], ...
'String','d/dt', ...
'Tag','Pushbutton1');
...
'BackgroundColor',[0.3 0.9 0.5], ...
'Position',[bb+bw+bs bstart-bv*3 bw bh], ...
'String','Save View', ...
'Tag','Pushbutton1');
uicontrol('Parent',ptr, ...
'Units','pixels', ...
...
'BackgroundColor',[0.3 0.9 0.5], ...
'Position',[bb+(bw+bs)*2 bstart-bv*3 bw bh], ...
'String','Delete View', ...
'Tag','Pushbutton1');
...
'BackgroundColor',[0.5 0.3 0.8], ...
'Position',[bb+bw+bs bstart-bv*4 bw bh], ...
'String','Clear Last', ...
'Tag','Pushbutton1');
uicontrol('Parent',ptr, ...
'Units','pixels', ...
...
'BackgroundColor',[0.5 0.3 0.8], ...
'Position',[bb+(bw+bs)*2 bstart-bv*4 bw bh], ...
'String','Clear All', ...
'Tag','Pushbutton1');
...
'BackgroundColor',[0.5 0.3 0.8], ...
'Position',[bb+bw+bs bstart-bv*5 bw bh], ...
'String','Del Plot', ...
'Tag','Pushbutton1');
uicontrol('Parent',ptr, ...
'Units','pixels', ...
...
'Position',[bb+(bw+bs)*2 bstart-bv*5 bw bh], ...
'String','Quit', ...
'Tag','Pushbutton1');
...
if exist('last_data','file'), % migration from last_data to .last_data
  unix('mv last_data .last_data');
end;

if exist('.last_data','file') && flag == 1,
...
if isempty(fname),
	[fname, new_pathname] = uigetfile('*','Select Data File',pathname);
	if (fname == 0),
		return;
	end;
