...
init_task_servo(void)
{
  ...
  addMiscSensorsToCollect();

  addCenterOfGravityToCollect();

  addBaseStateToCollect();
...
void addEndeffToCollect(){
	...
	for (i=1; i<=n_endeffs; ++i) {
	    ...
	    addVarToCollect((char *)&(cart_state[i].xd[_X_]),string,"m/s",DOUBLE,FALSE);
	    sprintf(string,"%s_yd",cart_names[i]);
	    addVarToCollect((char *)&(cart_state[i].xd[_Y_]),string,"m/s",DOUBLE,FALSE);
	    sprintf(string,"%s_zd",cart_names[i]);
	    addVarToCollect((char *)&(cart_state[i].xd[_Z_]),string,"m/s",DOUBLE,FALSE);

	    sprintf(string,"%s_xdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_state[i].xdd[_X_]),string,"m/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_ydd",cart_names[i]);
	    addVarToCollect((char *)&(cart_state[i].xdd[_Y_]),string,"m/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_zdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_state[i].xdd[_Z_]),string,"m/s^2",DOUBLE,FALSE);
	    ...
	    addVarToCollect((char *)&(cart_orient[i].add[_X_]),string,"rad/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_bdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_orient[i].add[_Y_]),string,"rad/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_gdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_orient[i].add[_Z_]),string,"rad/s^2",DOUBLE,FALSE);
	    ...
	    addVarToCollect((char *)&(cart_des_state[i].xd[_X_]),string,"m/s",DOUBLE,FALSE);
	    sprintf(string,"%s_des_yd",cart_names[i]);
	    addVarToCollect((char *)&(cart_des_state[i].xd[_Y_]),string,"m/s",DOUBLE,FALSE);
	    sprintf(string,"%s_des_zd",cart_names[i]);
	    addVarToCollect((char *)&(cart_des_state[i].xd[_Z_]),string,"m/s",DOUBLE,FALSE);

	    sprintf(string,"%s_des_xdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_des_state[i].xdd[_X_]),string,"m/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_des_ydd",cart_names[i]);
	    addVarToCollect((char *)&(cart_des_state[i].xdd[_Y_]),string,"m/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_des_zdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_des_state[i].xdd[_Z_]),string,"m/s^2",DOUBLE,FALSE);
	    ...
	    addVarToCollect((char *)&(cart_des_orient[i].ad[_Z_]),string,"rad/s",DOUBLE,FALSE);
	    ...
	    addVarToCollect((char *)&(cart_target_state[i].xd[_X_]),string,"m/s",DOUBLE,FALSE);
	    sprintf(string,"%s_tyd",cart_names[i]);
	    addVarToCollect((char *)&(cart_target_state[i].xd[_Y_]),string,"m/s",DOUBLE,FALSE);
	    sprintf(string,"%s_tzd",cart_names[i]);
	    addVarToCollect((char *)&(cart_target_state[i].xd[_Z_]),string,"m/s",DOUBLE,FALSE);

	    sprintf(string,"%s_txdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_target_state[i].xdd[_X_]),string,"m/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_tydd",cart_names[i]);
	    addVarToCollect((char *)&(cart_target_state[i].xdd[_Y_]),string,"m/s^2",DOUBLE,FALSE);
	    sprintf(string,"%s_tzdd",cart_names[i]);
	    addVarToCollect((char *)&(cart_target_state[i].xdd[_Z_]),string,"m/s^2",DOUBLE,FALSE);
...
void addCenterOfGravityToCollect(){
	...
	addVarToCollect((char *)&(cog.xd[_X_]),"cog_xd","m/s",DOUBLE,FALSE);
	addVarToCollect((char *)&(cog.xd[_Y_]),"cog_yd","m/s",DOUBLE,FALSE);
	addVarToCollect((char *)&(cog.xd[_Z_]),"cog_zd","m/s",DOUBLE,FALSE);
	...
	addVarToCollect((char *)&(cog_des.xd[_X_]),"cog_des_xd","m/s",DOUBLE,FALSE);
	addVarToCollect((char *)&(cog_des.xd[_Y_]),"cog_des_yd","m/s",DOUBLE,FALSE);
	addVarToCollect((char *)&(cog_des.xd[_Z_]),"cog_des_zd","m/s",DOUBLE,FALSE);
}

void addBaseStateToCollect(){
	addVarToCollect((char *)&(base_state.x[_X_]),"base_x","m",DOUBLE,FALSE);
	  ...
	  addVarToCollect((char *)&(base_state.xd[_X_]),"base_xd","m/s",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_state.xd[_Y_]),"base_yd","m/s",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_state.xd[_Z_]),"base_zd","m/s",DOUBLE,FALSE);

	  addVarToCollect((char *)&(base_state.xdd[_X_]),"base_xdd","m/s^2",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_state.xdd[_Y_]),"base_ydd","m/s^2",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_state.xdd[_Z_]),"base_zdd","m/s^2",DOUBLE,FALSE);
	  ...
	  addVarToCollect((char *)&(base_orient.ad[_A_]),"base_ad","rad/s",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_orient.ad[_B_]),"base_bd","rad/s",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_orient.ad[_G_]),"base_gd","rad/s",DOUBLE,FALSE);

	  addVarToCollect((char *)&(base_orient.add[_A_]),"base_add","rad/s^2",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_orient.add[_B_]),"base_bdd","rad/s^2",DOUBLE,FALSE);
	  addVarToCollect((char *)&(base_orient.add[_G_]),"base_gdd","rad/s^2",DOUBLE,FALSE);
}
