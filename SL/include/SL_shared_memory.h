...
extern "C" {
  ...
  extern SEM_ID             sm_robot_message_ready_sem; /* signals message to motor servo */
  ...
  extern smMessage         *sm_robot_message;
  extern SEM_ID             sm_robot_message_sem;
  ...
  void  sendMessageRobotServo(char *message, void *buf, int n_bytes);
