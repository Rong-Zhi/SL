...
extern "C" {
  ...
  static const GLfloat  SL_black[4]={(float)0.0,(float)0.0,(float)0.0,(float)1.0};
  static const GLfloat  SL_darkGray[4]={(float)0.5,(float)0.5,(float)0.5,(float)1.0};
  static const GLfloat  SL_gray[4]={(float)0.8,(float)0.8,(float)0.8,(float)1.0};
  static const GLfloat  SL_white[4]={(float)1.0,(float)1.0,(float)1.0,(float)1.0};
  static const GLfloat  SL_darkRed[4]={(float)0.5,(float)0.0,(float)0.0,(float)1.0};
  static const GLfloat  SL_red[4]={(float)1.0,(float)0.0,(float)0.0,(float)1.0};
  static const GLfloat  SL_darkGreen[4]={(float)0.0,(float)0.5,(float)0.0,(float)1.0};
  static const GLfloat  SL_green[4]={(float)0.0,(float)1.0,(float)0.0,(float)1.0};
  static const GLfloat  SL_darkBlue[4]={(float)0.0,(float)0.0,(float)0.5,(float)1.0};
  static const GLfloat  SL_blue[4]={(float)0.0,(float)0.0,(float)1.0,(float)1.0};
