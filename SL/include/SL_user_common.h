...
#include "Floating_Base.h"
  ...
  int           vision_servo_rate = VISION_SERVO_RATE;
  ...
  Matrix        Adof[N_DOFS+1];                /* homogeneous transformation matrices for all dofs */
  Matrix        Adof_des[N_DOFS+1];            /* homogeneous transformation matrices for all dofs */
  Matrix        Adof_sim[N_DOFS+1];            /* homogeneous transformation matrices for all dofs */
