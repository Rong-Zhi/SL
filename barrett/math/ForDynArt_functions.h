...
/* make sure that d values are not numerically problematic  */
if (fabs(d[8]) < 1.e-6) 
  d[8]=macro_sign(d[8])*1.e-6;
T178[1][2]=JA8[1][2];
T178[1][3]=JA8[1][3];
T178[1][4]=JA8[1][4];
