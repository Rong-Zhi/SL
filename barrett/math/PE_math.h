...
Xinv[1][4][1]=-(sstate1th*ZSFE);
Xinv[1][4][2]=-(cstate1th*ZSFE);
Xinv[1][4][3]=0;
Xinv[1][4][4]=cstate1th;
Xinv[1][4][5]=-sstate1th;
Xinv[1][4][6]=0;

Xinv[1][5][1]=cstate1th*ZSFE;
Xinv[1][5][2]=-(sstate1th*ZSFE);
Xinv[1][5][3]=0;
...
Xinv[3][5][1]=cstate3th*ZHR;
Xinv[3][5][2]=-(sstate3th*ZHR);
Xinv[3][5][3]=0;
Xinv[3][5][4]=sstate3th;
Xinv[3][5][5]=cstate3th;
Xinv[3][5][6]=0;

Xinv[3][6][1]=sstate3th*ZHR;
Xinv[3][6][2]=cstate3th*ZHR;
Xinv[3][6][3]=0;
...
Xinv[4][4][1]=cstate4th*YEB - sstate4th*ZEB;
Xinv[4][4][2]=-(sstate4th*YEB) - cstate4th*ZEB;
Xinv[4][4][3]=0;
Xinv[4][4][4]=0;
Xinv[4][4][5]=0;
Xinv[4][4][6]=-1;
...
Xinv[5][4][1]=-(cstate5th*YWR);
Xinv[5][4][2]=sstate5th*YWR;
Xinv[5][4][3]=0;
Xinv[5][4][4]=0;
Xinv[5][4][5]=0;
Xinv[5][4][6]=1;

Xinv[5][5][1]=cstate5th*ZWR;
Xinv[5][5][2]=-(sstate5th*ZWR);
Xinv[5][5][3]=0;
Xinv[5][5][4]=sstate5th;
Xinv[5][5][5]=cstate5th;
Xinv[5][5][6]=0;

Xinv[5][6][1]=sstate5th*ZWR;
Xinv[5][6][2]=cstate5th*ZWR;
Xinv[5][6][3]=-YWR;
...
Xinv[6][4][1]=-(sstate6th*ZWFE);
Xinv[6][4][2]=-(cstate6th*ZWFE);
Xinv[6][4][3]=0;
Xinv[6][4][4]=0;
Xinv[6][4][5]=0;
Xinv[6][4][6]=-1;
...
v1[4]=-(sstate1th*ZSFE*v0[1]) + cstate1th*ZSFE*v0[2] + cstate1th*v0[4] + sstate1th*v0[5];
v1[5]=-(cstate1th*ZSFE*v0[1]) - sstate1th*ZSFE*v0[2] - sstate1th*v0[4] + cstate1th*v0[5];
v1[6]=v0[6];

v2[1]=sstate2th*v1[2] + cstate2th*v1[3];
v2[2]=cstate2th*v1[2] - sstate2th*v1[3];
v2[3]=state[2].thd - v1[1];
v2[4]=sstate2th*v1[5] + cstate2th*v1[6];
v2[5]=cstate2th*v1[5] - sstate2th*v1[6];
v2[6]=-v1[4];

v3[1]=sstate3th*v2[2] - cstate3th*v2[3];
v3[2]=cstate3th*v2[2] + sstate3th*v2[3];
v3[3]=state[3].thd + v2[1];
v3[4]=cstate3th*ZHR*v2[2] + sstate3th*ZHR*v2[3] + sstate3th*v2[5] - cstate3th*v2[6];
v3[5]=-(sstate3th*ZHR*v2[2]) + cstate3th*ZHR*v2[3] + cstate3th*v2[5] + sstate3th*v2[6];
v3[6]=v2[4];

v4[1]=sstate4th*v3[2] + cstate4th*v3[3];
v4[2]=cstate4th*v3[2] - sstate4th*v3[3];
v4[3]=state[4].thd - v3[1];
v4[4]=(cstate4th*YEB - sstate4th*ZEB)*v3[1] + sstate4th*v3[5] + cstate4th*v3[6];
v4[5]=(-(sstate4th*YEB) - cstate4th*ZEB)*v3[1] + cstate4th*v3[5] - sstate4th*v3[6];
v4[6]=-(ZEB*v3[2]) + YEB*v3[3] - v3[4];

v5[1]=sstate5th*v4[2] - cstate5th*v4[3];
v5[2]=cstate5th*v4[2] + sstate5th*v4[3];
v5[3]=state[5].thd + v4[1];
v5[4]=-(cstate5th*YWR*v4[1]) + cstate5th*ZWR*v4[2] + sstate5th*ZWR*v4[3] + sstate5th*v4[5] - cstate5th*v4[6];
v5[5]=sstate5th*YWR*v4[1] - sstate5th*ZWR*v4[2] + cstate5th*ZWR*v4[3] + cstate5th*v4[5] + sstate5th*v4[6];
v5[6]=-(YWR*v4[3]) + v4[4];

v6[1]=sstate6th*v5[2] + cstate6th*v5[3];
v6[2]=cstate6th*v5[2] - sstate6th*v5[3];
v6[3]=state[6].thd - v5[1];
v6[4]=-(sstate6th*ZWFE*v5[1]) + sstate6th*v5[5] + cstate6th*v5[6];
v6[5]=-(cstate6th*ZWFE*v5[1]) + cstate6th*v5[5] - sstate6th*v5[6];
v6[6]=-(ZWFE*v5[2]) - v5[4];

v7[1]=sstate7th*v6[2] - cstate7th*v6[3];
v7[2]=cstate7th*v6[2] + sstate7th*v6[3];
v7[3]=state[7].thd + v6[1];
v7[4]=sstate7th*v6[5] - cstate7th*v6[6];
v7[5]=cstate7th*v6[5] + sstate7th*v6[6];
v7[6]=v6[4];
...
a1[4]=-(sstate1th*ZSFE*a0[1]) + cstate1th*ZSFE*a0[2] + cstate1th*a0[4] + sstate1th*a0[5] + state[1].thd*v1[5];
a1[5]=-(cstate1th*ZSFE*a0[1]) - sstate1th*ZSFE*a0[2] - sstate1th*a0[4] + cstate1th*a0[5] - state[1].thd*v1[4];
a1[6]=a0[6];
...
a2[4]=sstate2th*a1[5] + cstate2th*a1[6] + state[2].thd*v2[5];
a2[5]=cstate2th*a1[5] - sstate2th*a1[6] - state[2].thd*v2[4];
a2[6]=-a1[4];
...
a3[4]=cstate3th*ZHR*a2[2] + sstate3th*ZHR*a2[3] + sstate3th*a2[5] - cstate3th*a2[6] + state[3].thd*v3[5];
a3[5]=-(sstate3th*ZHR*a2[2]) + cstate3th*ZHR*a2[3] + cstate3th*a2[5] + sstate3th*a2[6] - state[3].thd*v3[4];
a3[6]=a2[4];
...
a4[4]=(cstate4th*YEB - sstate4th*ZEB)*a3[1] + sstate4th*a3[5] + cstate4th*a3[6] + state[4].thd*v4[5];
a4[5]=(-(sstate4th*YEB) - cstate4th*ZEB)*a3[1] + cstate4th*a3[5] - sstate4th*a3[6] - state[4].thd*v4[4];
...
a5[4]=-(cstate5th*YWR*a4[1]) + cstate5th*ZWR*a4[2] + sstate5th*ZWR*a4[3] + sstate5th*a4[5] - cstate5th*a4[6] + state[5].thd*v5[5];
a5[5]=sstate5th*YWR*a4[1] - sstate5th*ZWR*a4[2] + cstate5th*ZWR*a4[3] + cstate5th*a4[5] + sstate5th*a4[6] - state[5].thd*v5[4];
a5[6]=-(YWR*a4[3]) + a4[4];
...
a6[4]=-(sstate6th*ZWFE*a5[1]) + sstate6th*a5[5] + cstate6th*a5[6] + state[6].thd*v6[5];
a6[5]=-(cstate6th*ZWFE*a5[1]) + cstate6th*a5[5] - sstate6th*a5[6] - state[6].thd*v6[4];
a6[6]=-(ZWFE*a5[2]) - a5[4];
...
a7[4]=sstate7th*a6[5] - cstate7th*a6[6] + state[7].thd*v7[5];
a7[5]=cstate7th*a6[5] + sstate7th*a6[6] - state[7].thd*v7[4];
a7[6]=a6[4];
