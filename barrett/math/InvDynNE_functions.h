...
a1[4]=state[1].thd*v1[5] + ZSFE*a0[2]*S10[1][1] + a0[4]*S10[1][1] - ZSFE*a0[1]*S10[1][2] + a0[5]*S10[1][2];
a1[5]=-(state[1].thd*v1[4]) + ZSFE*a0[2]*S10[2][1] + a0[4]*S10[2][1] - ZSFE*a0[1]*S10[2][2] + a0[5]*S10[2][2];
a1[6]=a0[6];
